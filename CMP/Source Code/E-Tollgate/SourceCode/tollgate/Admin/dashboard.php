...
$query_view_admin = sprintf("SELECT * FROM staffdetails WHERE grpid ='grp01' ORDER BY sno ASC");
...
?>
		...
		<center> <a  style="font-size:20px"           href="../viewfeedback.php">View Feedback</a> </center>
                    	...
                    	<div class="grid_2">
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        <img src="images/icons/color/accept.png" alt="" />
                                        ADMIN DETAILS <span style="float:right; text-decoration:underline;"><a href="updatepro.php">Update</a></span>
                                    </span>
                                </div>
