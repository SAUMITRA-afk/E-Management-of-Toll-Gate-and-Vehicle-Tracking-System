...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "update_staff")) {
  ...
  $updateSQL = sprintf("UPDATE staffdetails SET name=%s, dob=%s, gender=%s, age=%s, address=%s, phone=%s, mobile=%s, mailid=%s, doj=%s, salary=%s, country=%s, location=%s, passwrd=%s, grpid=%s, designation=%s, branchid=%s, image=%s WHERE staffid=%s",
  ...
  $updateSQL2 = sprintf("UPDATE logindetails SET passwd=%s,id=%s,fullname=%s WHERE uname=%s",
                       GetSQLValueString($_POST['pass'], "text"),
  ...
  mysql_select_db($database_tollgate, $tollgate);
  $Result12 = mysql_query($updateSQL2, $tollgate) or die(mysql_error());

  $updateGoTo = "update_staff.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_staff_list1 = "-1";
if (isset($_SESSION['staffid'])) {
  $colname_staff_list1 = $_SESSION['staffid'];
}
mysql_select_db($database_tollgate, $tollgate);
...
$id=$staff_list1['staffid'];


$colname_row_branch = "-1";
if (isset($_SESSION['sno'])) {
  $colname_row_branch = $_SESSION['sno'];
}
mysql_select_db($database_tollgate, $tollgate);
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                	...
                	<!-- Content Area -->
                  <form method="POST" action="<?php echo $editFormAction; ?>" id="da-ex-validate_branch" class="da-form" name="update_staff" enctype="multipart/form-data">
                        	...
                        	<div class="da-panel">
                                ...
                                <div class="da-panel-content">
                                	 <?php if ($msg==1) {echo "<div class='da-message success'>
                                        Sucessfully Update Staff Deatils...
                                    </div>";}?>
       	        ...
       	        <div id="da-ex-val1-error" class="da-message error" style="display:none;"></div>
                                        ...
                                        <div class="da-form-inline">
                                                ...
                                                <div class="da-form-item default">
                                                    <input name="staffid" type="text" value="<?php echo $row_staff_list1['staffid']; ?>" readonly="readonly"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Name<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <input type="text" name="name" value="<?php echo $row_staff_list1['name']; ?>"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <select name="branid" id="branid" type="text" >
...
?>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="dob" class="datepicker" value="<?php echo $row_staff_list1['dob']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Age<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <input type="text" name="age" value="<?php echo $row_staff_list1['age']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    ...
                                                    <option selected="selected"><?php echo $row_staff_list1['gender']; ?></option>
                                                      <option>Male</option>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <textarea type="text" name="address" value""> <?php echo $row_staff_list1['address']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Phone<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <input type="text" name="phone" value="<?php echo $row_staff_list1['phone']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Mobile<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <input type="text" name="mobile" value="<?php echo $row_staff_list1['mobile']; ?>"/>
                                                </div>
                                            </div>
                    	...
                    	<div class="grid_2">
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        <img src="images/icons/color/accept.png" alt="" />
                                        ADD MORE DETAILS <span style="background:url(images/up.png) no-repeat; float:right; padding-left:20px; text-decoration:underline;"><a href="view_staff.php">Back To View</a></span>
                                    </span>
                                </div>
                                ...
                                <div class="da-panel-content">
                                        ...
                                        <div class="da-form-inline">
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="doj" class="datepicker" value="<?php echo $row_staff_list1['doj']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Email ID<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <input type="text" name="emailid" value="<?php echo $row_staff_list1['mailid']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Salary<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <input type="text" name="salary" value="<?php echo $row_staff_list1['salary']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Country <span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <select id="pass1" type="text" name="country" value"">
                                                     <option value="" selected="selected"><?php echo $row_staff_list1['country']; ?></option>
                                           ...
                                           <optgroup label="COUNTRY START FROM [B]">
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="location" value="<?php echo $row_staff_list1['location']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Password<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <input type="text" name="pass" value="<?php echo $row_staff_list1['passwrd']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Group ID<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <select type="text" name="grpid" value"">
													...
													if($row_staff_list1['grpid']=="grp03"){
                                                      ...
                                                      <option value="grp02">CEO</option>
                                                      <option value="grp03">Manager</option>
                                                      <option value="grp04">Staff</option>                                    
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="designation" value="<?php echo $row_staff_list1['designation']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                            	...
                                            	<input type="file" class="da-custom-file" name="image" value="<?php echo $row_staff_list1['image']; ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="da-button-row">
                                        	<input type="submit" value="Update Staff" class="da-button red" />
                                        </div>
                              </div>
                	...
                	<input type="hidden" name="MM_update" value="update_staff" />
                    </form> 
