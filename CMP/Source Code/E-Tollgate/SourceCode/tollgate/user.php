...
$db_name="tollgate"; // Database name
...
//'<script type="text/javascript">alert("SELECT * FROM $tbl_name WHERE name='navas' and password='navas123'");</script>';
}}
?>
...
<img src="images/login1.png" alt="Mountain View" style="width:304px;height:128px ;"></center>
<center>
...
<td ><input name="name" type="text"  placeholder="Enter Username"></td>
</tr>
<tr>


<td><input name="password" type="text"  placeholder="Enter Password"></td>
</tr>
<tr>
...
<a href="register.php">ClickHere to register</a>
