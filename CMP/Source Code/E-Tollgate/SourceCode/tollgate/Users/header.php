...
$query_admin_list = sprintf("SELECT * FROM userdetails WHERE cid ='$adid' ORDER BY sno ASC");
...
{
	var ret=confirm("Are You Want to Delete... ?");
	if(ret)
	{   
                    ...
                    <div id="da-header-toolbar" class="clearfix">
                        <div id="da-user-profile">
                          <div id="da-user-avatar">
                            ...
                            <div id="da-user-info">
                                <?php echo $row_admin_list['cname']; ?>
                                <span class="da-user-title">USER</span>
                            </div>
