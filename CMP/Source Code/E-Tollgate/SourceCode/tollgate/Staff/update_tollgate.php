...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "update_details")) {
  ...
  $image_name=$_POST['sno'];
  $newname="../staff_image/".$image_name.$image;
  move_uploaded_file( $_FILES["image"]["tmp_name"],$newname);
	
  $updateSQL = sprintf("UPDATE tollgatedetail SET tname=%s, location=%s, address=%s, postal=%s, URL=%s, country=%s, mobile=%s, phone=%s, mailid=%s, faxno=%s, image=%s, start_date=%s WHERE tid=%s",
  ...
  $updateGoTo = "update_tollgate.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_SESSION['sno'])) {
  $colname_view_company = $_SESSION['sno'];
}
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                	...
                	<!-- Content Area -->
                    <form name="update_details" action="<?php echo $editFormAction; ?>"  method="POST" id="da-ex-validate_branch" class="da-form" enctype="multipart/form-data">
                    	...
                    	<div class="grid_2">
                        	<div class="da-panel">
                                ...
                                <div class="da-panel-content">
                                        ...
                                        Sucessfully Updated Company Deatils...
                                    </div>";}?>
                                        ...
                                        <div class="da-form-inline">
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input name="cid" type="text" id="cid" value="<?php echo $row_view_company1['tid']; ?>" readonly="readonly"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Toll Gate Name<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <input name="cname" type="text" id="cname" value="<?php echo $row_view_company1['tname']; ?>"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="location" value="<?php echo $row_view_company1['location']; ?>"/>
                                                </div>
                                            </div>                                        
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="Postal" value="<?php echo $row_view_company1['postal']; ?>"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="url" value="<?php echo $row_view_company1['URL']; ?>"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <textarea type="text" name="address" value=""><?php echo $row_view_company1['address']; ?></textarea>
                                                </div>
                                            </div>
                    	...
                    	<div class="grid_2">
                        	<div class="da-panel">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                        <img src="images/icons/color/accept.png" alt="" />
                                        UPDATE TOLL GATE DETAILS <span style="background:url(images/up.png) no-repeat; float:right; padding-left:20px; text-decoration:underline;"><a href="view_tollgate.php">Back To View</a></span>
                                    </span>
                              </div>
                              <?php if ($msg==1) {echo "<div class='da-message success'>
                                        Sucessfully Updated Company Deatils...
                                ...
                                <div class="da-panel-content">
                                        ...
                                        <div class="da-form-inline">
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <select name="country" id="pass1" title="" type="text" value="<?php echo $row_view_company1['country']; ?>" >
                                                     <option value=""></option>
                                           ...
                                           <optgroup label="COUNTRY START FROM [B]">
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="mobile" value="<?php echo $row_view_company1['mobile']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Phone<span class="required">*</span></label>
                                                <div class="da-form-item default">
                                                    <input type="text" name="phone" value="<?php echo $row_view_company1['phone']; ?>" />
                                                </div>
                                            </div>                                            
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="emailid" value="<?php echo $row_view_company1['mailid']; ?>"/>
                                                </div>
                                            </div>                            
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="fax" value="<?php echo $row_view_company1['faxno']; ?>"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item default">
                                                    <input type="text" name="start" class="datepicker" value="<?php echo $row_view_company1['start_date']; ?>"/>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                            	...
                                            	<input type="file" class="da-custom-file" name="image" src="<?php echo $row_view_company1['image']; ?>" value=""/>
                                                </div>
                                            </div>                                           
...
<?php
mysql_free_result($view_company1);
