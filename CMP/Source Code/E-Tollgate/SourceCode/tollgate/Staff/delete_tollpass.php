...
$query_view_company = "SELECT * FROM userdetails where stfid ='".$_SESSION['id']."' ORDER BY sno DESC";
                    	...
                    	<div class="grid_4">
                        	<div class="da-panel collapsible">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                       ...
                                       View Toll Pass Details &nbsp;&nbsp;&nbsp; <font style="color:#900; font-weight:bold"> Total Entry By The Staff :</font><blink><font style="font-weight:bold"> <?php echo $totalRows_view_company;?></font></blink>
                                    </span>
                         ...
                         <?php if ($msg==1) {echo "<div class='da-message success'>
                                    ...
                                    <table id="da-ex-datatable-numberpaging" class="da-table">
                                        ...
                                        <?php do{?>
                                        <tr>                                                
                                                <td><?php echo $row_view_company['cid']; ?></td>
                                                <td><?php echo $row_view_company['cname']; ?></td>                                                <td><?php echo $row_view_company['from']; ?></td>
                                              ...
                                              <td><?php echo $row_view_company['amount']; ?></td>
                                                 <td class="da-icon-column">
                                                    ...
                                                    <a href="" onclick="return conf_del('<?php echo $row_view_company['sno']; ?>')"><img src="images/icons/color/cross.png" /></a>
